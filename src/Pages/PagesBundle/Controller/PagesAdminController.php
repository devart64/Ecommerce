...
use Pages\PagesBundle\PagesController;
...
class PagesAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('administration/pages/index.html.twig', array(
            'pages' => $pages,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('administration/pages/new.html.twig', array(
            'page' => $page,
    ...
    public function showAction(Pages $page)
    {
        ...
        return $this->render('administration/pages/show.html.twig', array(
            'page' => $page,
    ...
    public function editAction(Request $request, Pages $page)
    {
        ...
        return $this->render('administration/pages/edit.html.twig', array(
            'page' => $page,
